...
<body>
    <nav class="navbar navbar-expand-lg ">
        <div class="container-fluid">
            ...
            <div>
                <a class="fri-image-a" href="https://www.fri.uniza.sk/"><img src="Images/FRI_logo.png" class="fri-image" alt="FRI"></a>
            </div>
                ...
                <ul class="navbar-nav me-auto mb-2 mb-lg-0">
                    ...
                    <li class="nav-item dropdown">
                        ...
                        <ul class="dropdown-menu">
                            <li><a class="dropdown-item" href="prace.php">Záverečné práce</a></li>
